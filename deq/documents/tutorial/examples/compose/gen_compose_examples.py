...
from snippet_utils import extract_block, run_cli, write_snippet
...
for example in examples:
    ...
    if returncode != 0:
        if "cannot export stim" in stderr:
            print(
                "    (stim export skipped — COMPOSE gadgets have no physical circuit)"
            )
        else:
            print(stderr)
