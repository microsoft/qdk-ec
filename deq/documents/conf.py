...
project = "deq"
copyright = "2025, Microsoft Quantum"
...
# auto versioning
# version = '{}'.format(deq.__version__)
...
nitpick_ignore = [
    ("py:class", "sortedcontainers.sorteddict.SortedDict"),
    ("py:class", "sympy.geometry.point.Point"),
    ("py:class", "sympy.matrices.dense.MutableDenseMatrix"),
    ("py:class", "sympy.core.expr.Expr"),
    ("py:class", "symengine.lib.symengine_wrapper.Expr"),
    ("py:class", "Multiset"),
]
