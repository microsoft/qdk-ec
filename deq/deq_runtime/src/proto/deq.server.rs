        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn shutdown(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/deq.server.Server/Shutdown",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("deq.server.Server", "Shutdown"));
...
pub mod server_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/deq.server.Server/Shutdown" => {
                    ...
                    struct ShutdownSvc<T: Server>(pub Arc<T>);
                    impl<T: Server> tonic::server::UnaryService<()> for ShutdownSvc<T> {
                        type Response = ();
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as Server>::shutdown(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "deq.server.Server";
